...
return [
    ...
    */
    ...
    'relationships' => [
    'ressources' => [  // This must match your table name exactly
        'supplier' => [  // Must match the method name in your model (supplier())
            'type'  => 'belongsTo',
            'model' => 'App\\Supplier',
            'foreign_key' => 'supplier_id',  // Explicitly define
            'key' => 'id',  // Explicitly define
            'show' => ['raisonSocial'],  // Array format for field(s) to display
        ],
    ],
    ]
