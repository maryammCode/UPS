...
<body>
    ...
    <div class="table-responsive">
        ...
        <div class="rela-block top-bar">
            <div class="caps name">
                <div class="abs-center">{{ @$user->name }}</div>
            </div>
        </div>
        <div class="side-bar" @style('min-height:28cm')>
            <div class="mugshot">
                <div class="logo">
                    <img src="{{ Voyager::image(@$user->avatar) }}" alt="photo" style="width: 140pt;">
                    <p class="logo-text"></p>
                </div>
            </div>

            <p>Télèphone : {{ @$user->phone }}</p>
            <p>Adresse : {{ @$user->address }}</p>
            <p>Email : {{ @$user->email }} </p><br>
            {{--
                                                        <p class="rela-block social twitter">Twitter stuff</p> --}}
            <p class="rela-block social pinterest">{{ @$user->email }}
            </p>
            <p class="rela-block social linked-in">
                {{ @$user->linkedin }}</p>
            <p class="rela-block social github">{{ @$user->github }}
            </p>
        ...
        <div class="rela-block content-container">
            ...
            {{-- <div class="rela-block caps greyed">Profile</div>
                                                        <p class="long-margin">Retro DIY quinoa, mixtape williamsburg
                                                            master cleanse bushwick tumblr chillwave dreamcatcher hella
                                                            wolf paleo. Knausgaard semiotics truffaut cornhole hoodie,
                                                            YOLO meggings gochujang tofu. Locavore ugh kale chips iPhone
                                                            biodiesel typewriter freegan, kinfolk brooklyn kitsch man
                                                            bun. Austin neutra etsy, lumbersexual paleo cornhole
                                                            sriracha kinfolk meggings kickstarter. </p> --}}
