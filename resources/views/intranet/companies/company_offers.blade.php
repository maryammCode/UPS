    ...
    <div class="row">
        <div class="col-md-12 fcrse_2" style="padding-bottom: 30px;">
            <div class="value_content stage_header">
                ...
                <button class="btn btn-info" data-toggle="modal" data-target="#exampleModal"> @lang('intranet.Ajouter') </button>
            </div>
        </div>
        @if ($offres->count() > 0)
            <div class="_215td5 col-md-12" style="padding-top: 10px;">
                <div>
                    <table id="company_offers" class="table ucp-table">
                        <thead class="thead-s">
                            <tr>
                        ...
                        <tbody>
                            @foreach (@$offres as $offre)
                                <tr>
                                    ...
                                    <td class="text-center"> {{ @$offre->offerType->designation_fr }} </td>
                                    ...
                                    <td class="text-center">
                                        @if ($offre->publier == 1)
                                            <span class="badge badge-success">@lang('intranet.Validée')</span>
                                        @else
                                            <span class="badge badge-danger">@lang('intranet.Non validée')</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        @if ($offre->mode == 1)
                                            <span class="badge badge-danger">@lang('intranet.Privé')</span>
                                        @else
                                            <span class="badge badge-success">@lang('intranet.Public')</span>
                                        @endif
                                    </td>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="new-section">
                                                                    <div class="form_group ui search focus">
                                                                        <label for="">@lang('intranet.Types')</label>
                                                                        <div class="ui left icon  swdh11 swdh19">

                                                                            <select class="ui hj145  cntry152 prompt srch_explore mt-10 form-control" name="offer_type_id">

                                                                                @foreach ($offer_types as $type )
                                                                                    <option value="{{$type->id}}" {{ $offre->offer_type_id == $type->id ? 'selected' : '' }}>{{$type->designation_fr}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
        ...
        <div class="modal-dialog add_stage" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('addOffers') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body ">
                        <div class="ui search focus">
                            ...
                            <div class="ui form swdh30">
                                <select class="ui hj145 dropdown cntry152 prompt srch_explore mt-10" name="offer_type_id">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('intranet.Fermer')</button>
                        <button type="submit" class="btn btn-info">@lang('intranet.Sauvegarder')</button>
                    </div>
                </form>
            </div>
        </div>
