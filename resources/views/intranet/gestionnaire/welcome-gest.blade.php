...
<!-- Container for button + i icon aligned in same line -->
<div style="display: flex; justify-content: space-between; align-items: center;">
    <!-- Button -->
    <a href="{{ route('rapport.download') }}" 
...
<!-- iframe -->
<div style="position: relative;">
    <iframe title="PFEPartieBI" width="800" height="500.5" src="https://app.powerbi.com/view?r=eyJrIjoiNDdkZGIzYTItMTMxMi00NmM3LWJjMjAtNGY1OWVhZTViMWNiIiwidCI6ImRiZDY2NjRkLTRlYjktNDZlYi05OWQ4LTVjNDNiYTE1M2M2MSIsImMiOjl9" frameborder="0" allowFullScreen="true"></iframe>
</div>
