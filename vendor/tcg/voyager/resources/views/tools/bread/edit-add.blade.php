                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-2 form-group">
                                    <label for="auto_filter">Auto Date/year Filter</label><br>
                                    <?php $checked = (isset($dataType->auto_filter) && $dataType->auto_filter == 1) || (isset($auto_filter) && $auto_filter); ?>
                                    <input type="checkbox"
                                           name="auto_filter"
                                           class="toggleswitch"
                                           data-on="{{ __('voyager::generic.yes') }}"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="description">Route statistiques personnalisé</label>
                                    <input class="form-control"
                                              name="statistiques_route"
                                              placeholder="{{ __('voyager::bread.statistiques_route') }}"
                                              value="{{ @$dataType->statistiques_route }}">
                                </div>
                            </div>
                            @if(isset($dataType))
                            <hr>
                            <b>Imporation Excel</b>
                            <div class="row">
                                <div class="col-md-3 form-group">
                                    <label for="description">Path du modele Excel</label>
                                    <input class="form-control"
                                              name="modele_excel"
                                              placeholder="{{ __('voyager::bread.modele_excel') }}"
                                              value="{{ $dataType->modele_excel ?? 'excel/model.xlsx' }}"
                                    >
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="description">Required Columns | séparés par ;</label>
                                    <input class="form-control"
                                              name="required_columns"
                                              placeholder="required_columns"
                                              value="{{ $dataType->required_columns}}"
                                    >
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="description">unique test columns | exemple : Stage-stage_id</label>
                                    <input class="form-control"
                                              name="unique_columns1"
                                              placeholder="unique_columns1"
                                              value="{{ $dataType->unique_columns1}}"
                                    >
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="description">unique couple columns | exemple : Horaire_de_debut-horaire_start;date;Salle-salle</label>
                                    <input class="form-control"
                                              name="unique_columns2"
                                              placeholder="unique_columns2"
                                              value="{{ $dataType->unique_columns2}}"
                                    >
                                </div>
                            </div>
                            @endif
