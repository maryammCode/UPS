                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    @foreach($dataTypeContent as $data)
                                        @if( $dataType->slug == 'teachers')
                                            <?php $teacher_info = App\Teacher::find($data->getKey()); ?>
                                            <?php $verif = App\Models\User::where('cin', @$teacher_info->cin)->first(); ?>
                                            @if($verif)
                                                <?php $etat = "Avec Compte"; ?>
                                            @else
                                                <?php $etat = "Sans Compte"; ?>
                                            @endif
                                        @endif
                                    <tr @if( $dataType->slug == 'teachers') @if($verif) style="background : #d7ffee;" @else style="background : #ffe9e9;"@endif @endif>
                                        @if($showCheckboxColumn)
                                            <td>
