...
@section('page_header')
    ...
    <div class="container-fluid">
        ...
        @endcan
        {{-- Importation & exportation btns start --}}
        @php
        $tab_table_with_import_export =[
           'news',
           'personals',
           'books',
           'themes',
           ...
           'contacts',
           'news-categories',
           'form-fiche-renseignements',
           'notes',
           'emplois',
           'students-predefined-lists',
           'specialites',
           'offers',
           'objectifs',
           'partners',
   ...
   @endphp
        ...
        @if (in_array($dataType->slug , $tab_table_with_import_export ))
                    ...
                    <div class="container" style="direction: ltr;">
                        <div class="row" style="flex-wrap: nowrap; margin-top:22px;">
                            <div class="timeline-steps aos-init aos-animate" data-aos="fade-up"
                                ...
                                @php
                                    $model_excel = 'models/' . $dataType->slug . '.xlsx';
                                @endphp

                                <a style="margin: 4%" href="{{ asset($model_excel) }}" class="btn btn-primary"><i
