                ...
                <div class="col-md-8">
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="cin">{{ __('voyager::generic.cin') }}</label>
                                <input type="text" class="form-control" id="cin" name="cin"
                                    placeholder="{{ __('voyager::generic.cin') }}"
                            ...
                            <div class="form-group">
                                <label for="date_birth">{{ __('voyager::generic.date_birth') }}</label>
                                <input type="date" class="form-control" id="date_birth" name="date_birth"
                                    placeholder="{{ __('voyager::generic.date_birth') }}"
                                    value="{{ old('date_birth', $dataTypeContent->date_birth ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="address">{{ __('voyager::generic.address') }}</label>
                                <input type="text" class="form-control" id="address" name="address"
                                    placeholder="{{ __('voyager::generic.address') }}"
                                    value="{{ old('address', $dataTypeContent->address ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="phone">{{ __('voyager::generic.phone') }}</label>
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="{{ __('voyager::generic.phone') }}"
                                    value="{{ old('phone', $dataTypeContent->phone ?? '') }}">
                            </div>
                            <div class="form-group">
                                <label for="phone2">{{ __('voyager::generic.phone2') }}</label>
                                <input type="text" class="form-control" id="phone2" name="phone2"
                                    placeholder="{{ __('voyager::generic.phone2') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea  class="form-control" id="description" name="description" rows="5" 
                                    placeholder="{{ __('voyager::generic.description') }}" 
                                    value="{{ old('description', $dataTypeContent->description ?? '') }}"></textarea>
                            </div>
