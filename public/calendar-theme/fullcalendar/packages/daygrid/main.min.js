...
!(function (e, t) {
            ...
            return (
                ...
                (r.prototype.buildRenderRange = function (r, n, i) {
                    ...
                    if (
                        (/^(year|month)$/.test(n) &&
                            ((a = s.startOfWeek(a)),
                            (o = s.startOfWeek(d)).valueOf() !== d.valueOf() &&
                                (d = t.addWeeks(o, 1))),
        ...
        s = (function () {
            ...
            return (
                ...
                (e.prototype.destroy = function () {
                    this.hide(),
                        this.el && (t.removeElement(this.el), (this.el = null)),
                    ...
                    (e = n.top || 0),
                        (r =
                            void 0 !== n.left
                                ...
                                ? n.right - o.width
                                : 0),
                        (e = Math.min(e, l.bottom - o.height - this.margin)),
                        (e = Math.max(e, l.top + this.margin)),
                        (r = Math.min(r, l.right - o.width - this.margin)),
                        (r = Math.max(r, l.left + this.margin)),
            ...
            return (
                ...
                (r.prototype.renderSegHtml = function (e, r) {
                    ...
                    return (
                        ...
                        (i =
                            '<span class="fc-title">' +
                            (t.htmlEscape(d.title || "") || "&nbsp;") +
                            "</span>"),
                        '<a class="' +
                            g.join(" ") +
                            '"' +
                            (d.url
                                ? ' href="' + t.htmlEscape(d.url) + '"'
                                : "") +
                            (m ? ' style="' + m + '"' : "") +
            ...
            return (
                ...
                (r.prototype.renderSegRow = function (e, r) {
                    ...
                    for (n = 0; n < f; n++) {
                        ...
                        C &&
                            (c.isRtl
                                ? t.appendToElement(s, C)
                                : t.prependToElement(s, C)),
                            g.appendChild(s);
                    }
                    return {
                        row: e,
    ...
    var h = (function (e) {
                ...
                (r.prototype.attachSegs = function (e, r) {
                    ...
                    this.dayGrid.rowEls.forEach(function (e, r) {
                        ...
                        n && n.row === r
                            ...
                            (l.style.top = s + "px"),
                            l.querySelector("table").appendChild(i[r].tbodyEl),
                            e.appendChild(l);
                    });
                }),
                r
            ...
            return (
                ...
                (r.prototype.renderFillRow = function (e, r) {
                    ...
                    return (
                        h &&
                            (s.isRtl
                                ? t.appendToElement(o, h)
                                : t.prependToElement(o, h)),
                        i
                    );
                }),
                r
        ...
        u = (function (e) {
            function r(r, n) {
                ...
                return (
                    (i.renderFgEvents = t.memoizeRendering(
                        o.renderSegs.bind(o),
                        o.unrender.bind(o),
                        [s]
                    )),
                    (i.renderEventSelection = t.memoizeRendering(
                        o.selectByInstanceId.bind(o),
                        o.unselectByInstanceId.bind(o),
                        [i.renderFgEvents]
                    )),
                    (i.renderEventDrag = t.memoizeRendering(
                        o.hideByHash.bind(o),
                        o.showByHash.bind(o),
                        [s]
                    )),
                    (i.renderEventResize = t.memoizeRendering(
                        o.hideByHash.bind(o),
                        o.showByHash.bind(o),
                        [s]
                    )),
                    r.calendar.registerInteractiveComponent(i, {
                        el: i.el,
                        useEventCenter: !1,
                    }),
                    i
            ...
            return (
                ...
                (r.prototype._renderFrame = function (e) {
                    var r = this.theme,
                        n = this.dateEnv.format(
                            e,
                            t.createFormatter(this.opt("dayPopoverFormat"))
                        );
                    (this.el.innerHTML =
                        '<div class="fc-header ' +
                ...
                (r.prototype.queryHit = function (e, r, n, i) {
                    ...
                    if (e < n && r < i)
                        return {
                            ...
                            dateSpan: {
                                allDay: !0,
                                range: { start: o, end: t.addDays(o, 1) },
                            },
                            dayEl: this.el,
            ...
            return (
                (e.prototype.renderHtml = function (e) {
                    ...
                    for (var r = 0, n = e.cells; r < n.length; r++) {
                        var i = n[r];
                        t.push(
                            m(i.date, e.dateProfile, this.context, i.htmlAttrs)
                        );
                    }
                    return (
                        e.cells.length ||
    ...
    function m(e, r, n, i) {
        ...
        return (
            a.unshift("fc-day", s.getClass("widgetContent")),
            '<td class="' +
                a.join(" ") +
                '"' +
                (l
    ...
    var y = t.createFormatter({ day: "numeric" }),
        v = t.createFormatter({ week: "numeric" }),
        b = (function (e) {
            function r(r, n, i) {
                ...
                var d = (o.renderCells = t.memoizeRendering(
                    o._renderCells,
                    o._unrenderCells
                ));
                return (
                    ...
                    (o.renderDateSelection = t.memoizeRendering(
                        l.renderSegs.bind(l, "highlight"),
                        l.unrender.bind(l, "highlight"),
                        [d]
                    )),
            ...
            return (
                ...
                (r.prototype._renderCells = function (e, r) {
                    ...
                    for (
                        this.el.innerHTML = d,
                            ...
                            this.cellEls = t.findElements(
                                this.el,
                                ".fc-day, .fc-disabled-day"
                            ),
                            this.isRtl && this.cellEls.reverse(),
                            this.rowPositions = new t.PositionCache(
                                this.el,
                                this.rowEls,
                                !1,
                                !0
                    ...
                    return a || this.renderProps.cellWeekNumbersVisible
                        ? ((r = t.getDayClasses(
                          ...
                          (s +=
                              ...
                              (l
                                  ? ' data-date="' +
                                    o.formatIso(e, { omitTime: !0 }) +
                                    '"'
                                  : "") +
                              ">"),
                          this.renderProps.cellWeekNumbersVisible &&
                              e.getUTCDay() === n &&
                              (s += t.buildGotoAnchorHtml(
                                  i,
                                  { date: e, type: "week" },
                        ...
                        this.unlimitRow(t),
                            !1 !==
                                (r =
                                    ...
                                    ("number" == typeof e
                                        ? e
                                        : this.computeRowLevelLimit(t))) &&
                                this.limitRow(t, r);
                }),
                (r.prototype.computeRowLevelLimit = function (e) {
                    var r,
                        n,
                        i = this.rowEls[e].getBoundingClientRect().bottom,
                        o = t.findChildren(
                            this.eventRenderer.rowStructs[e].tbodyEl
                        );
                    for (r = 0; r < o.length; r++)
                        if (
                            ((n = o[r]).classList.remove("fc-limited"),
                            n.getBoundingClientRect().bottom > i)
                        )
                            return r;
                    return !1;
                }),
                (r.prototype.limitRow = function (e, r) {
                    var n,
                        ...
                        R = function (n) {
                            for (; E < n; )
                                (a = v.getCellSegs(e, E, r)).length &&
                                    ((h = i[r - 1][E]),
                                    (y = v.renderMoreLink(e, E, a)),
                                    (m = t.createElement("div", null, y)),
                                    h.appendChild(m),
                                    C.push(m)),
                                    E++;
                        };
                    if (r && r < S.segLevels.length) {
                        for (
                            n = S.segLevels[r - 1],
                                i = S.cellMatrix,
                                (o = t
                                    .findChildren(S.tbodyEl)
                                    .slice(r)).forEach(function (e) {
                            ...
                            for (R(H), c = [], d = 0; E <= D; )
                                (a = this.getCellSegs(e, E, r)),
                                    c.push(a),
                                    (d += a.length),
                                    E++;
                            if (d) {
                                for (
                                    p = (h = i[r - 1][H]).rowSpan || 1,
                                        u = [],
                                        f = 0;
                                    f < c.length;
                                    f++
                                    ...
                                    (g = t.createElement("td", {
                                        ...
                                        u.push(g),
                                        C.push(g);
                                h.classList.add("fc-limited"),
                                    t.insertAfterElement(h, u),
                                    o.push(h);
                            }
                        }
                ...
                (r.prototype.unlimitRow = function (e) {
                    ...
                    r.moreEls &&
                        (r.moreEls.forEach(t.removeElement),
                        (r.moreEls = null)),
                        r.limitedEls &&
                ...
                (r.prototype.renderMoreLink = function (e, r, n) {
                    ...
                    return (
                        ...
                        l.addEventListener("click", function (t) {
                            ...
                            "function" == typeof l &&
                                (l = i.publiclyTrigger("eventLimitClick", [
                                    {
                                        date: s.toDate(d),
                                        allDay: !0,
                                        dayEl: h,
                                ...
                                "popover" === l
                                    ? i.showSegPopover(e, r, c, u)
                                    : "string" == typeof l &&
                                      o.calendar.zoomTo(d, l);
                        }),
                        l
                    );
                }),
                (r.prototype.showSegPopover = function (e, r, n, i) {
                    var o,
                        ...
                        f = n.parentNode;
                    (o = 1 === this.rowCnt ? c.el : this.rowEls[e]),
                        (l = {
                            className:
                                "fc-more-popover " + h.getClass("popover"),
                            parentEl: c.el,
                            top: t.computeRect(o).top,
                            autoHide: !0,
                            content: function (t) {
                                (a.segPopoverTile = new u(a.context, t)),
                                    a.updateSegPopoverTile(
                                        a.props.cells[e][p].date,
                                        i
                                    );
                            },
                            hide: function () {
                                a.segPopoverTile.destroy(),
                                    (a.segPopoverTile = null),
                                    a.segPopover.destroy(),
                                    (a.segPopover = null);
                            },
                        }),
                        this.isRtl
                            ? (l.right = t.computeRect(f).right + 1)
                            : (l.left = t.computeRect(f).left - 1),
                        (this.segPopover = new s(l)),
                        ...
                        p &&
                            s.push(
                                i({}, d, {
                                    ...
                                    isStart:
                                        d.isStart &&
                                        p.start.valueOf() === h.start.valueOf(),
                                    isEnd:
                                        d.isEnd &&
                                        p.end.valueOf() === h.end.valueOf(),
                                })
                            );
                    }
                    return s;
        ...
        S = (function (e) {
            function r(r, n, i, o) {
                ...
                var l = s.scroller.el;
                s.el.querySelector(".fc-body > tr > td").appendChild(l),
                    l.classList.add("fc-day-grid-container");
                var a,
                    d = t.createElement("div", { className: "fc-day-grid" });
                return (
                    l.appendChild(d),
                    s.opt("weekNumbers")
                        ? s.opt("weekNumbersWithinDays")
                            ? ((a = !0), (s.colWeekNumbersVisible = !1))
                            : ((a = !1), (s.colWeekNumbersVisible = !0))
                        : ((s.colWeekNumbersVisible = !1), (a = !1)),
                    (s.dayGrid = new b(s.context, d, {
            ...
            return (
                ...
                (r.prototype.updateBaseSize = function (e, r, n) {
                    ...
                    s.rowEls
                        ? (this.colWeekNumbersVisible &&
                              (this.weekNumberWidth = t.matchCellWidths(
                                  t.findElements(this.el, ".fc-week-number")
                              )),
                          this.scroller.clear(),
                          a && t.uncompensateScroll(a),
                          s.removeSegPopover(),
                ...
                (r.prototype.computeScrollerHeight = function (e) {
                    return (
                        e - t.subtractInnerElHeight(this.el, this.scroller.el)
                    );
                }),
                (r.prototype.setGridHeight = function (e, r) {
                    this.opt("monthMode")
                        ? (r && (e *= this.dayGrid.rowCnt / 6),
                          t.distributeHeight(this.dayGrid.rowEls, e, !r))
                        : r
                        ? t.undistributeHeight(this.dayGrid.rowEls)
                        : t.distributeHeight(this.dayGrid.rowEls, e, !0);
                }),
    ...
    var C = (function (e) {
        ...
        R = (function (e) {
            function r(r, n, i, o) {
                var s = e.call(this, r, n, i, o) || this;
                return (
                    (s.buildDayTable = t.memoize(H)),
                    s.opt("columnHeader") &&
                        (s.header = new t.DayHeader(
                            s.context,
                            s.el.querySelector(".fc-head-container")
                        )),
                    (s.simpleDayGrid = new C(s.context, s.dayGrid)),
                    s
                );
            }
            return (
    ...
    (e.AbstractDayGridView = S),
        (e.DayBgRow = g),
        (e.DayGrid = b),
        (e.DayGridSlicer = E),
        (e.DayGridView = R),
        (e.SimpleDayGrid = C),
        (e.buildBasicDayTable = H),
        (e.default = D),
